...
describe('Problem 001: Multiples of 3 and 5', () => {
  test('The sum of all multiples of 3 and 5 below 1,000 is 233,168.', () => {
...
describe('Problem 002: Even Fibonacci Numbers', () => {
  test('The sum of even-valued terms below 4,000,000 is 4,613,732.', () => {
...
describe('Problem 006: Sum Square Difference', () => {
  test('The difference between the sum of the squares of the first 10 natural numbers and the square of the sum is 2,640.', () => {
    expect(sumSquareDifference(10)).toBe(2640)
  })

  test('The difference between the sum of the squares of the first 100 natural numbers and the square of the sum is 25,164,150.', () => {
